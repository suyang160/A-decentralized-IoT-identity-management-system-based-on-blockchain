 ...
 */
package com.example.suyang.bluetooth;
...
import com.example.suyang.ui.device.DeviceFragment;
...
public class BluetoothChatService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(DeviceFragment.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        //将连接的设备的名称发送回UI活动
        Message msg = mHandler.obtainMessage(DeviceFragment.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(DeviceFragment.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        // 将失败消息发送回活动
        Message msg = mHandler.obtainMessage(DeviceFragment.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(DeviceFragment.TOAST, "无法连接设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(DeviceFragment.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(DeviceFragment.TOAST, "丢失设备连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run()
        {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(DeviceFragment.MESSAGE_READ, bytes, -1, buffer)
        ...
        public void write(byte[] buffer) {
            try {
                ...
                //将发送的消息共享回UI活动
                mHandler.obtainMessage(DeviceFragment.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
